...
("With a fruity citrus and diesel aroma, Jack Skellington promises an intensely psychoactive experience that brings creativity and introspection to a new level.", "Sativa", "Earthy, Diesel, Pungent", "/assets/images/skellington.jpg", 12),
("Lavender and purple hues tinge leaves and buds underneath a dusty coat of snow-white resin. This strain gets its name from the sour grape aroma its buds carry, which is accented by spicy, hashy undertones.", "Hybrid", "Grape, Tropical, Berry", "/assets/images/queen.jpg", 13),
("Liquid Butter will have you melting into the couch or your favorite tub of ice cream. Patients who suffer from pain and anxiety typically have success with this strain, but it’s best to use Liquid Butter when you don’t have a lot to get done.", "Indica", "Butter, Sweet, Honey", "/assets/images/butter.jpg", 14),
("The taste of Master Kush is reminiscent of the famous hard-rubbed charas hash. This strain holds a superb balance of full-body relaxation without the mind-numbing effect that many indica strains produce.", "Indica", "Earthy, Pungent, Woody", "/assets/images/masterkush.jpg", 15),
("This strain induces relaxing effects that sink deeper in the body over time. You may find your eyelids feeling heavy before long, but don’t let a name like Night Terror OG fool you: a good night’s sleep is on its way.", "Indica", "Earthy, Berry, Sweet", "/assets/images/terror.jpg", 16),
("Peyote Cookies is a vigorous hybrid flower that is easy to grow and pleasurable to consume. The flowering plant displays a dazzling ruby red and purple complexion coupled with delicious flavors of guava, vanilla, coffee, and earth.", "Indica", "Earthy, Sweet, Lime", "/assets/images/peyotecookies.jpg", 17),
("Sugar Breath has beautiful dense buds coated in trichomes. The aroma is a sweet, gassy blend that also includes notes of pine, incense, vanilla, and cinnamon. The potent high may provide a relaxing evening of laughter and snacks.", "Hybrid", "Sweet, Pine, Vanilla", "/assets/images/sugar.jpg", 18),
("Walter White has an aroma and taste are citrusy and creamy on the exhale.", "Hybrid", "Earthy, Woody, Citrus", "/assets/images/ww.jpg", 19),
("The genetics root this strain in uplifting sativa effects while its recessive indica-dominant genetics imbue the plant with flavors of lime leaves and grape jelly. For consumers seeking an energizing boost that improves mood and helps combat depression.", "Sativa", "Lemon, Spicy/Herbal, Citrus", "/assets/images/zgift.jpg", 20);